...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Interprise\Logger\Model\CronActivitySchedule')->load($id);
            if (!$model->getId() && $id) {
            ...
            return $resultRedirect->setPath('*/*/edit', ['cronactivityschedule_id' => $this->getRequest()->getParam('cronactivityschedule_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}
