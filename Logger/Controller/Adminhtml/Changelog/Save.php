...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Interprise\Logger\Model\Changelog')->load($id);
            if (!$model->getId() && $id) {
            ...
            return $resultRedirect->setPath('*/*/edit', ['changelog_id' => $this->getRequest()->getParam('changelog_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}
